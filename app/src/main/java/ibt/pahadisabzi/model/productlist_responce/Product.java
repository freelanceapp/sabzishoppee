...
public class Product implements Parcelable, Comparable<Product> {
    ...
    protected Product(Parcel in) {
        ...
        this.rateQuantity = ((String) in.readValue((String.class.getClassLoader())));
    }
    ...
    public int compareTo(@NonNull Product product) {
        return (Double.parseDouble(this.getSellingPrice()) < Double.parseDouble(product.getSellingPrice()) ? -1 :
    ...
    public static Comparator<Product> hightolowComparator = new Comparator<Product>() {
        ...
        public int compare(Product jc1, Product jc2) {
            return (Double.parseDouble(jc1.getSellingPrice()) > Double.parseDouble(jc2.getSellingPrice()) ? -1 :
