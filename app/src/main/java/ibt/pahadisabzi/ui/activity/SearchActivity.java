...
import ibt.pahadisabzi.adapter.SearchListAdapter;
...
public class SearchActivity extends BaseActivity implements View.OnClickListener, SearchListAdapter.SearchAdapterListener{
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnAdd :
                ...
                productDetail.setDescription(allUserLists.get(position).getRateQuantity());
    ...
    private void plusItem(View view, int pos) {
        ...
        productDetail.setDescription(allUserLists.get(pos).getRateQuantity());
    ...
    public void onSearchSelected(Product contact) {
       ...
       // position = Integer.parseInt(view.getTag().toString());
        ...
        productDetail.setDescription(contact.getRateQuantity());
