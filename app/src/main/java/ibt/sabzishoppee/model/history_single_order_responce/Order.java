...
package ibt.sabzishoppee.model.history_single_order_responce;
...
public class Order implements Parcelable
{
    ...
    protected Order(Parcel in) {
        ...
        in.readList(this.product, (ibt.sabzishoppee.model.history_single_order_responce.Product.class.getClassLoader()));
    }
